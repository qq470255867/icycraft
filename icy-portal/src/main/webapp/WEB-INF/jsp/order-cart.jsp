...
<form id="orderForm" class="hide" action="/order/create.html" method="post">
		...
		<input type="hidden" name="orderShipping.receiverName" value="测试用户"/>
		<input type="hidden" name="orderShipping.receiverMobile" value="111111"/>
		<input type="hidden" name="orderShipping.receiverState" value="测试地址"/>
		<input type="hidden" name="orderShipping.receiverCity" value="测试地址"/>
		<input type="hidden" name="orderShipping.receiverDistrict" value="测试地址"/>
		<input type="hidden" name="orderShipping.receiverAddress" value="测试地址"/>
</form>
...
<div class="step-tit">
	<h3>收货人信息（暂未实现敬请期待）</h3>
	<div class="extra-r">
		<a href="#none" class="ftx-05" onclick="use_NewConsignee()">新增收货地址（暂未实现敬请期待）</a>
	</div>
</div>
<div class="step-cont">
   			...
   			<ul class="ui-switchable-panel-main" id="consignee-list">
				...
				<li class="ui-switchable-panel" id="consignee_index_137617472"
					...
					<div class="consignee-item item-selected"
						...
						<div class="user-name">
							<div class="fl">
								<strong limit="4">测试用户</strong>&nbsp;&nbsp;收
							</div>
							<div class="fr">10086</div>
							<div class="clr"></div>
						</div>
						<div class="mt10" limit="15">测试地址</div>
						<div class="adr-m" limit="30">测试地址</div>
...
<div class="shopping-list ABTest">
	<div class="goods-list">
     <!--配送方式-->
    <h4 class="vendor_name_h" id="0">商家：冰笑风云</h4>		         
		...
		<div class="mode-tab-nav">
			<ul>
				<li class="mode-tab-item " id="jd_shipment_item"
					...
					id="jdShip-span-tip" class="m-txt">圆通快递<i
						class='qmark-icon qmark-tip'
						data-tips=''></i></span><b></b></li>
			</ul>
		</div>
	</div>
</div>
    ...
    <div class="ui-ceilinglamp checkout-buttons">
      ...
      <div class="sticky-wrap">
          ...
          <div style="display:none" id="factoryShipCodShowDivBottom" class="dispatching">
            部分商品货到付款方式：先由我们配送“提货单”并收款，然后厂商发货。
          </div>
        </div>
