...
<div class="w">
    <div id="logo">
    	<a href="http://localhost:8082" clstag="passport|keycount|login|01">
    		<img src="/images/icy-logo.gif" alt="淘淘" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
        ...
        <div class="mc " id="bgDiv">
            ...
            <div class="form ">
                ...
                <div class="item login-btn2013">
                    <input type="button" class="button" id="loginsubmit" value="" tabindex="8" clstag="passport|keycount|login|06"><button type="submit" title="Vote" class="button"><span><span>Vote</span></span></button></input>
                </div>
            </div>
        </div>
